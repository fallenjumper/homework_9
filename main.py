...
with open(filename, "w")as f:
    ...
    f.write(f"Всего RSS памяти используется: {round(get_total(data, 'RSS') / 1024 / 1024, 1)}Mb\n")
    f.write(f"Всего VSZ памяти используется: {round(get_total(data, 'VSZ') / 1024 / 1024, 1)}Mb\n")
